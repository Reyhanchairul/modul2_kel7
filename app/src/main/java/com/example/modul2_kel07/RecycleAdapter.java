...
import com.example.modul2_kel07.DetailActivity;
import com.example.modul2_kel07.R;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, @SuppressLint("RecyclerView") int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra( "tvLastName", dataUser.get(i).getLastName());
                intent.putExtra("tvEmail", String.format("Email : %s", dataUser.get(i).getEmail()));
                intent.putExtra("imgPhotoUser", dataUser.get(i).getAvatar());
